      ...
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="text-lg font-black uppercase text-white leading-none tracking-tight">
                {t("schoolName")}
              </span>
              <span className="text-[0.55rem] font-bold tracking-[0.3em] uppercase text-secondary mt-1">
                {t("schoolSub")}
              </span>
            </div>
          </div>
        ...
        {/* Column 2: Academic Divisions */}
        <div className="space-y-4">
          <h4 className="text-xs font-bold tracking-[0.2em] text-secondary uppercase">
            {t("academicsHeader")}
          </h4>
          <ul className="space-y-3 text-sm font-semibold text-white/70">
            <li><Link href="/academics" className="hover:text-secondary transition-colors">{t("earlyYears")}</Link></li>
            <li><Link href="/academics" className="hover:text-secondary transition-colors">{t("primaryEd")}</Link></li>
            <li><Link href="/academics" className="hover:text-secondary transition-colors">{t("secondaryEd")}</Link></li>
          </ul>
        </div>
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-3 text-sm font-semibold text-white/70">
            <li><Link href="/about" className="hover:text-secondary transition-colors">{t("aboutLink")}</Link></li>
            <li><Link href="/admissions" className="hover:text-secondary transition-colors">{t("admissionsLink")}</Link></li>
            <li><Link href="/calendar" className="hover:text-secondary transition-colors">{t("calendarLink")}</Link></li>
            <li><Link href="/portal" className="hover:text-secondary transition-colors flex items-center gap-1">{t("portalLink")} <ArrowUpRight size={12} /></Link></li>
          </ul>
        </div>
